...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/potturisumanth/metric-server-k8s.git  and run the following command from
